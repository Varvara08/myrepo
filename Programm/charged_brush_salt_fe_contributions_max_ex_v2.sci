...
dfedx = dfedx + (1-lambda)/(q+1) * ((1/3 *dsddz4+0.5)*log(1+2*s+3*dz4) + (dsddz4/3 -0.5)*log(1+2*s-3*dz4) - 2/3 *dsddz4*log(1-s))*ddz4dx;///
...
fa = fa + (1+2*s+3*dz4)/6 *log(1+2*s+3*dz4) + (1+2*s-3*dz4)/6 *log(1+2*s-3*dz4) + 2/3 *(1-s)*log(1-s);////
