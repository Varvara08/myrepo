...
f = f +t*((1.0-lambda)/(q+1) *((1+2*s+3*dz3)/6 *log(1+2*s+3*dz3) + (1+2*s-3*dz3)/6 *log(1+2*s-3*dz3) + 2/3 *(1-s)*log(1-s)));// + вклад от растяжения длинного пути звезд нижней популяции
...
dfedx = dfedx + t*((1-lambda)/(q+1) * ((1/3 *dsddz3+0.5)*log(1+2*s+3*dz3) + (dsddz3/3 -0.5)*log(1+2*s-3*dz3) - 2/3 *dsddz3*log(1-s))*ddz3dx);
...
//f(2)
fa = t*((1+2*s+3*dz3)/6 *log(1+2*s+3*dz3) + (1+2*s-3*dz3)/6 *log(1+2*s-3*dz3) + 2/3 *(1-s)*log(1-s));
