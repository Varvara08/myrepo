...
def findmin(To_finding_min):
    ...
    #~ def findmax(To_finding_max,num):
    #~ nmax=0 
    #~ l=num
    #~ while (nmax==0) and (l > 0):
        #~ if To_finding_max[l-2] < To_finding_max[l-1]:
    ...
    #~ return num
#~ 
#~ def findmin(To_finding_min,num):
    #~ nmin=0
    #~ l=num
    #~ while (nmin==0) and (l > 0):
        #~ if To_finding_min[l-2] > To_finding_min[l-1] :
...
def lambdafind(To_finding_bp,To_finding_ne):
    ...
    while j<5:
     #~ if (findmin(To_finding_ne))>0 or (findmax(To_finding_ne))>0:
      extremdatane['min'+str(j)]=findmin(To_finding_ne)
      extremdatane['max'+str(j)]=findmax(To_finding_ne)
     #~ if (findmin(To_finding_bp))>0 or (findmax(To_finding_bp))>0:
