...
#        self.fnamedat = self.fname+".dat" # for two population of brush
    ...
    def inputfilegen(self):
        ...
        if self.iguess_in != '':
            if os.path.exists('data/'+self.iguess_in):
        ...
        inputfile = open('data/'+self.fnamein,'w')
        #~ print (self.fnamein)
    ...
    def sfbox(self):
        ...
        self.solved = False
        self.__init__()
        if os.path.exists('data/'+self.fnameout):
    ...
    def plotProfile(self, profile_name = 'sys : noname : potential'):
        ...
        #x_dataname = dataprefix+what_toPhi
