...
class brush():
    ...
    def plotProfile(self, profile_name = 'sys : noname : potential'):
        ...
        try:
            ...
            graph6 = g.Root.page1.grid1.graph7
            graph7 = g.Root.page1.grid1.graph8
        ...
        y_axis.min.val = 1e-4
        x_axis.max.val = 200
        y_axis.label.val = '\italic{\\phi_{calc}}'
        x_axis.label.val = '\italic{z}'

        ########################
        graph = graph1
        ## Plot counterions #
        what_toPlot = 'zbp_calc'
        ...
        # Plot the calculated distribution of the branching points
        what_toPlot = 'V_calc'
        profile_toPlot = potention_formula
        y_dataname = dataprefix+what_toPlot
